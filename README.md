...
- `NPM_RC_FILE`: (optional) Path to a custom .npmrc file you want to update (Default: `~/`)
...
- `--config-path`: Set to `~/` by default. Can be used to configure a custom .npmrc file to edit
